...
import { TvShow } from "../hooks/usePopularTvShows";
...
const TvShowCard = ({ tvShow }: Props) => {
  ...
  return (
    <div className=" p-4">
      <div
        className="relative h-64 rounded-lg overflow-hidden shadow-lg transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-105"
        style={{
      ...
      >
        <div className="absolute justify-between bottom-0 w-full h-15 bg-white bg-opacity-20 backdrop-blur-sm flex items-center p-4">
